...
HD_PWD='C:/Users/15002/OneDrive/ECE212/Lab3_Ex/Lab3_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LEDMatrixTopLevel.vds -m64 -mode batch -messageDb vivado.pb -notrace -source LEDMatrixTopLevel.tcl
