...
HD_PWD='C:/Users/15002/OneDrive/ECE212/Lab3_Ex/Lab3_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LEDMatrixTopLevel.vdi -applog -m64 -messageDb vivado.pb -mode batch -source LEDMatrixTopLevel.tcl -notrace
